      ...
      <div className="container">
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-6 col-lg-3">
            ...
            >
              <a href="index.html">
                <img src="images/fredsFaceLogo.jpg" alt="image" />
              </a>
            </div>
          </div>
          <div className="col-xs-12 col-sm-12 col-md-6 col-lg-3">
            ...
            >
              ...
              <ul>
                <li>
                  Monday - Friday
                  <em>08:00 am - 10:00pm</em>
                </li>
                <li>
                  Saturday - Sunday
                  <em>08:00 am - 11:00pm</em>
                </li>
                <li>
                  <strong>Closed Holidays</strong>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center">
            ...
            <div
              ...
              data-animate="active"
            >
              Copyright © 2023 Alien Fred's Games. All Rights Reserved.
            </div>
          </div>
        </div>
      </div>
